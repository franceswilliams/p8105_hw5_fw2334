...
The sample average of b1 is higher than the true value of β1. A higher estimated effect size leads to rejecting the null, therefore if we eliminate values for which the null is not rejected our average effect size is going to be larger. 
